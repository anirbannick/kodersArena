...
document.title=document.title + " | Compilation Result";
	...
	<div class="body-content-result">
		...
		if($res[3]>500)
		print "<BR> <b> Number of submissions limit (500) has already been reached OR You have been disqualified.</b>";
		else 
		{
			$solved = $res[2];
			...
			{	
				print "<BR> <b>You have already submitted a correct solution to this problem</b>";
			}
